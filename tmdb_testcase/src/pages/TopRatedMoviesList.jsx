...
const TopRatedMoviesList = () => {
    ...
    return  <div className='flex flex-col flex-wrap w-full items-center lg:items-center justify-center mt-0 mb-32 lg:mb-36'>
                <h4 className='flex items-center w-full h-[30vh] md:h-[50vh] lg:h-[90vh] bg-top bg-cover bg-no-repeat bg-center pl-12 sm:pl-16 md:pl-20 lg:pl-24 xl:pl-20 2xl:pl-36 text-white text-4xl sm:text-5xl xl:text-6xl 2xl:text-8xl font-bold lg:font-extrabold lg:mt-0'>TOP filmer</h4>
                <div className='flex flex-col lg:flex-row lg:flex-wrap items-center justify-between md:w-[80%] lg:w-[100%] mt-12 lg:mt-12 md:mt-32 xl:mt-36 lg:px-10 xl:px-20 2xl:px-36'>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between h-[100px]">
                        <div className="flex w-full items-end justify-center md:mr-6 mt-10 md:mt-8 mb-2 md:mb-4 xl:mr-8">
            ...
            <div className='flex flex-col lg:flex-row lg:flex-wrap lg:items-center lg:justify-center lg:w-[100%] xl:justify-center w-[85%] lg:gap-6 xl:gap-x-8 xl:gap-y-20 mt-24 lg:mt-12 md:mt-32 xl:ml-0'>
        {movies.filter((value) => {
            if(search === '') {
                return value
            ...
            return <MovieTopRated key={id} {...movieTop} />
        })}
        </div>
    </div>
}
