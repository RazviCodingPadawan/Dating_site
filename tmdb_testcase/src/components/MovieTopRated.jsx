...
const Movie =(movie)=> {
  ...
  return <div className="flex flex-row flex-wrap xl:items-center xl:justify-center">
        <div className="hidden lg:flex items-start justify-between rounded-xl shadow-xl bg-gradient-to-t from-[#de3535] to-[#1d1d1d] lg:w-[490px] xl:w-[560px] xl:h-[420px]">
          <a className='flex flex-col items-center justify-center' href="#!">
            <img className="rounded-bl-xl rounded-tl-xl	object-cover h-[420px] min-w-[290px]" src={getPosterPath(posterpath)} alt=""/>
          </a>
          <div className="flex flex-col items-start w-full h-full justify-between">
            <div className='flex flex-col w-full items-start justify-center min-h-[150px] bg-[#121212] rounded-tr-2xl'>
